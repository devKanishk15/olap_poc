...
def generate_chunk(rng: np.random.Generator, start_id: int, n: int) -> pa.Table:
    ...
    arrays = [
        ...
        pa.array(product_price.tolist(), type=pa.decimal128(12, 2)),
        pa.array(quantity.tolist()),
        pa.array(order_ids.tolist()),
        pa.array(order_totals.tolist(), type=pa.decimal128(14, 2)),
        pa.array(disc_amts.tolist(), type=pa.decimal128(10, 2)),
        pa.array(coupons.tolist()),
        pa.array(revenue_arr.tolist(), type=pa.decimal128(14, 4)),
